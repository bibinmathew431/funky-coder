...
if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
	...
	if($count > 0){
		...
		echo "<br>";
		echo "<br>";
		echo "<a href='paymentform.php'><img src='checkout.jpg' style='width:150px; height:50px;'></img></a> ";
		echo "<br>";
		echo "<br>";
		echo "<button style='margin-left:400px';'type='button' class='btn btn-warning btn-lg'><a href='profile.php'>Back to Shopping </a></button>";
